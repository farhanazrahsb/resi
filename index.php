    ...
    <div class="panel panel-success">
     ...
     <div class="panel-body">
      <form action="" method="POST">
       ...
       <input type="radio" name="tiki" value="tiki"> TIKI
       <input type="radio" name="pos" value="pos"> POS
       <input type="radio" name="sicepat" value="sicepat"> SiCepat
       <input type="radio" name="anteraja" value="anteraja"> Anter Aja
       <input type="radio" name="ninja" value="ninja"> Ninja
       <input type="radio" name="jnt" value="jnt"> JNT
       </div>
     </div>
